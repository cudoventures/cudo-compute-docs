...
//     -o ./mdocs/help -d ./mdocs/images/help --update-nav ./docs.json
// Options:
//   -i, --input <file>        CSV export file from Contentful
//   -o, --out <dir>           Root output directory for help articles (default: mdocs/help)
//   -d, --assets <dir>        Directory to store downloaded images (default: mdocs/images/help)
...
function parseArgs(argv) {
    const args = { input: null, out: 'mdocs/help', assets: 'mdocs/images/help', dryRun: false, force: false, verbose: false, updateNav: null, genIndex: false };
...
function printHelp() {
    console.log(`Usage: node lib/genHelpFromCsv.js -i <input.csv> [options]\n` +
        ...
        `  -o, --out <dir>           Output directory for help articles (default mdocs/help)\n` +
        `  -d, --assets <dir>        Image asset directory (default mdocs/images/help)\n` +
