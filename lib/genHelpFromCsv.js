...
//   -o, --out <dir>           Root output directory for help articles (default: /help)
//   -d, --assets <dir>        Directory to store downloaded images (default: /images/help)
...
function parseArgs(argv) {
    const args = { input: null, out: '/help', assets: '/images/help', dryRun: false, force: false, verbose: false, updateNav: null, genIndex: false };
...
function printHelp() {
    console.log(`Usage: node lib/genHelpFromCsv.js -i <input.csv> [options]\n` +
        ...
        `  -o, --out <dir>           Output directory for help articles (default /help)\n` +
        `  -d, --assets <dir>        Image asset directory (default /images/help)\n` +
