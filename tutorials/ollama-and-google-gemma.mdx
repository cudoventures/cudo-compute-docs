...
- Download the [CLI tool](/docs/cli-tool)
...
To use the command line tool you will need to get an API key from the web console, see here: [API key](/docs/getting-started)
