...
All resources on the platform are chargeable, including but not limited to:

- Virtual Machine CPU, GPU and memory
- Storage (including disk storage for private images)
- Network IP reservation

### Auto recharge

To keep your billing account topped up and to prevent automatic resource deletion, you can configure auto recharge. This allows you to top your balance up when it falls to a certain amount. See our guide on [how to configure auto recharge]"/guides/billing-accounts/configure-auto-recharge).
