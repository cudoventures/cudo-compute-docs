...
<Note>
We also recommend [configuring auto-recharge]"/guides/billing-accounts/configure-auto-recharge) to prevent your resources from being deleted when your credit balance is insufficient.
</Note>
