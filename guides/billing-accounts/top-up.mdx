...
Click **Continue** and the amount will be credited to your billing account. To find out more about how billing works, [see billing account documentation](/billing)

<Note>
We also recommend [configuring auto-recharge]"/docs/guides/billing-accounts/configure-auto-recharge) to prevent your resources from being deleted when your credit balance is insufficient.
</Note>
