...
You can [create a bare metal machine](/bare-metal/create-a-bare-metal-machine) without any kind of configuration. This is useful if you want to create a bare metal machine quickly (to reserve in-demand machines or create many machines ahead of time) and then configure it later.
