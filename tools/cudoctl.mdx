...
<Note>
You will need to **[create an API key](/api/authentication#create-an-api-key)** from the **[web UI](https://compute.cudo.org/profile/api-keys?create=api-key)** before you can use cudoctl.
</Note>
