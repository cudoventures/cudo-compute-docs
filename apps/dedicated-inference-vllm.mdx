---
title: Dedicated LLM inference
description: Quick deploy popular LLMs on a dedicated GPU.
---
...
![Meta data](/images/docs/images/apps/dedicated-inference-vllm/meta-data.png)
