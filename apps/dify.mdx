...
![Create Admin Account](/docs/images/apps/dify/1.png)
...
![Ollama model provider](/docs/images/apps/dify/2.png)
...
![Ollama model set up](/docs/images/apps/dify/3.png)
