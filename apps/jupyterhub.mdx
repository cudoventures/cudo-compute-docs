...
![CPU and Memory Usage](/images/docs/images/apps/jupyterhub/usage.png)
...
![Sign In](/images/docs/images/apps/jupyterhub/signin.png)
...
![Hub Control](/images/docs/images/apps/jupyterhub/hubcontrol.png)

Click **Add Users** to add a list of users, each username should be on a new line.

![Add Users](/images/docs/images/apps/jupyterhub/addusers.png)

Users can now sign in and create their own password.

![User List](/images/docs/images/apps/jupyterhub/userlist.png)
