...
For more information on how to use the console and create a bucket, see the [Minio documentation](https://min.io/docs/minio/kubernetes/upstream/administration/minio-console.html).
