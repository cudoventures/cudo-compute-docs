...
<Accordion icon="rocket" title="Deploy using the dashboard or API">
  You can deploy resources using the [web dashboard](https://compute.cudo.org/) or programmatically using our [CLI tool](/docs/tools/cudoctl) or [REST API](/docs/api).
...
<Note>
  **Need help?** See our [help articles](/docs/help) or [open a support ticket](https://compute.cudo.org/?support=open).
</Note>
