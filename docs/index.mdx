...
<CardGroup cols={3}>
  ...
  <Card title="Terraform" icon="/docs/images/terraform.svg" href="https://registry.terraform.io/providers/CudoVentures/cudo/latest/docs" target="_blank">Manage infrastructure as code.</Card>
</CardGroup>
