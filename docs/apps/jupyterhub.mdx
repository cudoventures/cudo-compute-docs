---
title: JupyterHub
description: Multi-user Jupyter Notebooks on CUDO Compute.
---
...
## Get started
Go to the apps section in the CUDO Compute console and click either the small, medium or large instance of JupyterHub. This will give you some good default settings but, you can fully customise your deployment at the next step.
...
![CPU and Memory Usage](/docs/images/apps/jupyterhub/usage.png)
...
![Sign In](/docs/images/apps/jupyterhub/signin.png)
...
![Hub Control](/docs/images/apps/jupyterhub/hubcontrol.png)

Click **Add Users** to add a list of users, each username should be on a new line.

![Add Users](/docs/images/apps/jupyterhub/addusers.png)

Users can now sign in and create their own password.

![User List](/docs/images/apps/jupyterhub/userlist.png)
