...
<Cards>
  <Card title="Create a disk" href="/docs/guides/disks/create-a-disk" description="How to create detachable disks" />
  <Card title="Manage a disk" href="/docs/guides/disks/manage-a-disk" description="Attach, detach & delete disks" />
</Cards>
