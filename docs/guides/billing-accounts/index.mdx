...
To keep your billing account topped up and to prevent automatic resource deletion, you can configure auto recharge. This allows you to top your balance up when it falls to a certain amount. See our guide on [how to configure auto recharge]"/docs/guides/billing/configure-auto-recharge).
