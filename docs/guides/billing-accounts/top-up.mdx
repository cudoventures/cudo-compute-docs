...
<Note>
We also recommend [configuring auto-recharge]"/docs/guides/billing/configure-auto-recharge) to prevent your resources from being deleted when your credit balance is insufficient.
</Note>
