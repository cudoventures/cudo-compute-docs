...
{/* <Checklist>
  <CheckItem>Provision and manage <Link href="/docs/guides/clusters/0.index">clusters</Link> (GPU & CPU capacity)</CheckItem>
  <CheckItem>Create, start, stop and resize <Link href="/docs/guides/virtual-machines/0.index">virtual machines</Link> & bare metal machines</CheckItem>
  <CheckItem>Attach, detach, and resize <Link href="/docs/guides/volumes/0.index">volumes</Link> and manage <Link href="/docs/guides/disks/0.index">disks</Link></CheckItem>
  <CheckItem>Manage <Link href="/docs/guides/networks/0.index">networks</Link>, security groups, and ingress controls</CheckItem>
  <CheckItem>Import, list and manage machine <Link href="/docs/guides/images/0.index">images</Link></CheckItem>
  <CheckItem>Work with <Link href="/docs/guides/object-storage/0.index">object storage</Link></CheckItem>
...
<Card title="OpenAPI (v1)" icon="file" target="_blank" href="/docs/api/openapi.json">
