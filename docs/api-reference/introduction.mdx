...
<CardGroup cols={3}>
  <Card title="cudoctl CLI" icon="terminal" href="/docs/tools/cli">Script resource lifecycle operations quickly.</Card>
...
Additional automation tooling examples (dstack, Terraform, Python) are covered in the <Link href="/docs/tools/cli">Tools</Link> section.
...
<AccordionGroup>
  ...
  <Accordion title="Create infrastructure" icon="rocket">
    Follow the <Link href="/docs/quickstart">Quickstart</Link> then deploy your first cluster or virtual machine.
  </Accordion>
