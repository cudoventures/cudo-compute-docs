...
<Note type="info">These guides are designed to get you started with common applications and workloads on CUDO Compute. For detail on CUDO Compute resource specifics, refer to the <Link href="/mdocs/guides">Guides</Link> section.</Note>
