...
Any disk in the Ready state can be attached to a VM in the same data center. Open the action menu (⋮) for the disk and choose **Attach disk to virtual machine**, pick the VM and confirm.

You will now see the disk listed on the VM details page.

## Detach a disk

Open the action menu and choose **Detach disk from virtual machine**. Confirm to detach. The disk can then be attached to another VM.
