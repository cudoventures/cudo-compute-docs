...
Click **Continue** and the amount will be credited to your billing account. To find out more about how billing works, [see billing account documentation](/mdocs/billing)

<Note>
We also recommend [configuring auto-recharge]"/mdocs/guides/billing/configure-auto-recharge) to prevent your resources from being deleted when your credit balance is insufficient.
</Note>
