...
1. **[Create an API key](/api-reference/api-keys/create-an-api-key)** from the **[web UI](https://compute.cudo.org/profile/api-keys?create=api-key)**
2. Download and install cudoctl command line tool from **[here](/tools/cli)**
