...
- Download the [CLI tool](/mdocs/cli-tool)
...
You can use the web console to start a virtual machine using the **Ubuntu 22.04 + NVIDIA drivers + Docker** image or alternatively use the command line tool ``cudoctl``

To use the command line tool you will need to get an API key from the web console, see here: [API key](/mdocs/getting-started)
